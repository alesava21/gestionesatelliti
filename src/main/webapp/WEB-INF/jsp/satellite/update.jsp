			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="update_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/executeUpdate" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-3">
									<label for="dataDiLancio" class="form-label">Data di Lancio <span class="text-danger">*</span></label>
	                        		...
	                        		<input class="form-control ${status.error ? 'is-invalid' : ''}" id="dataDiLancio" type="date" placeholder="dd/MM/yy"
	                            		title="formato : gg/mm/aaaa"  name="dataDiLancio" required 
	                            		value="${parsedDate}" >
		                            </spring:bind>
	                      
								</div>
								
								<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date' value='${update_satellite_attr.dataDiRientro}' />
								<div class="col-md-3">
									<label for="dataDiRientro" class="form-label">Data di Rientro <span class="text-danger">*</span></label>
                        			<spring:bind path="dataDiRientro">
	                        		<input class="form-control ${status.error ? 'is-invalid' : ''}" id="dataDiRientro" type="date" placeholder="dd/MM/yy"
	                            		title="formato : gg/mm/aaaa"  name="dataDiRientro" required 
	                            		value="${parsedDate}" >
		                            </spring:bind>
