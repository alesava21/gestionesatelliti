										...
										<tr>
											...
											<td>
												...
												<c:if test="${satelliteItem.dataDiLancio == null}">
													<a class="btn btn-outline-info btn-sm" href="${pageContext.request.contextPath}/satellite/launch/${satelliteItem.id }">Lancia</a>
												</c:if>
												<c:if test="${satelliteItem.dataDiLancio != null &&  satelliteItem.dataDiRientro == null}">
													<a class="btn btn-outline-warning btn-sm" href="${pageContext.request.contextPath}/satellite/rientro/${satelliteItem.id }">Rientra</a>
												</c:if>
											</td>
										</tr>
									</c:forEach>
